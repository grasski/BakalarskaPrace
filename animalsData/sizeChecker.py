...
# Directories
path = os.path.join("data", "labeled", "zebra")
train_directory = os.path.join(path, "train")  # It should contain the xml files with bounding boxes
test_directory = os.path.join(path, "test")  # It should contain the xml files with bounding boxes
